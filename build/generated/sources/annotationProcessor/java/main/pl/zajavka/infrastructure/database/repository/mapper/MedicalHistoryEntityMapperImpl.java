...
@Component
public class MedicalHistoryEntityMapperImpl implements MedicalHistoryEntityMapper {

    @Override
    public MedicalHistoryEntity mapToEntity(MedicalHistory medicalHistory) {
    ...
    protected Set<MedicalHistoryEntity> medicalHistorySetToMedicalHistoryEntitySet(Set<MedicalHistory> set) {
        ...
        for ( MedicalHistory medicalHistory : set ) {
            set1.add( mapToEntity( medicalHistory ) );
        }
    ...
    protected Set<Visit> visitEntitySetToVisitSet(Set<VisitEntity> set) {
        ...
        for ( VisitEntity visitEntity : set ) {
            set1.add( visitEntityToVisit( visitEntity ) );
        }
    ...
    protected VisitNote visitNoteEntityToVisitNote(VisitNoteEntity visitNoteEntity) {
        ...
        visitNote.visit( visitEntityToVisit( visitNoteEntity.getVisit() ) );
    ...
    protected Visit visitEntityToVisit(VisitEntity visitEntity) {
        ...
        visit.visitNote( visitNoteEntityToVisitNote( visitEntity.getVisitNote() ) );
    ...
    protected Set<MedicalHistory> medicalHistoryEntitySetToMedicalHistorySet(Set<MedicalHistoryEntity> set) {
        ...
        for ( MedicalHistoryEntity medicalHistoryEntity : set ) {
            set1.add( mapFromEntity( medicalHistoryEntity ) );
        }
